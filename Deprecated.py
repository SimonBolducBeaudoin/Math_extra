...
def moment(hx,hs,exp,n_total,no_clip=True):
    ...
    return old_div((tmp.sum(axis=-1)),n_total)
...
def dydx_centered_3pnts(x,y):
    ...
    out[...,0]    = old_div((y[...,1]-y[...,0]),(x[...,1]-x[...,0]))
    out[...,1:-1] = ( old_div((x[...,1:-1]-x[...,2:]),((x[...,:-2] -x[...,1:-1])*(x[...,:-2 ]-x[...,2:  ]))) )*y[...,0:-2] + \
                    ( old_div((2*x[...,1:-1]-x[...,0:-2]-x[...,2:]),((x[...,1:-1]-x[...,0:-2])*(x[...,1:-1]-x[...,2:  ]))) )*y[...,1:-1] +  \
                    ( old_div((x[...,1:-1]-x[...,0:-2]),((x[...,2:]  -x[...,:-2 ])*(x[...,2:  ]-x[...,1:-1]))) )*y[...,2:  ]
    out[...,-1]       = old_div((y[...,-1]-y[...,-2]),(x[...,-1]-x[...,-2]))
    return out
...
def central_derivative_9points(dx,y):
    ...
    bigO dx**8
    """    
    return old_div((3.*y[:-8]-32.*y[1:-7]+168.*y[2:-6]-672.*y[3:-5]+672.*y[5:-3]-168.*y[6:-2]+32.*y[7:-1]-3.*y[8:]),(840.*dx))
